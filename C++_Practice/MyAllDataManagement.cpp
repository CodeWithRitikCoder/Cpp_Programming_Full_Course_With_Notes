...
class StudentDataManagement{
    private:
        ...
        int CountStudentData, SelectNumber1, SelectNumber2, SelectNumber3;
...
// int CountStudentDataInFile= 0;
    ...
    public:
        ...
        int studentDataSwitchCaseMenu();

};


//This is my Stduent class function definition section.
int StudentDataManagement::getStudentDataFormUser(){
    cout<<endl<<"\t***********************************************"<<endl;
    cout<<"\t\t\t**************"<<endl;
    ...
    cout<<endl<<"\tDo you want to store your data in DataBase. -- (Yes/NO)."<<endl;
    ...
    if(StoreStudentDataInDataBase== "Yes" || StoreStudentDataInDataBase== "yes" || StoreStudentDataInDataBase== "Y" || StoreStudentDataInDataBase== "y"){
        ...
        cout<<endl<<"\tYour Data is parmanentely stroed in DataBase."<<endl;
    ...
    cout<<endl<<"press (1) to goto SDM Switch menu, otherwise press (0)."<<endl;
    cout<<"\tEnter your choice here = ";
    cin>>SelectNumber1;
...
int StudentDataManagement::studentDataSwitchCaseMenu(){
    int choice;
    cout<<endl<<"\a\t***********************************************"<<endl;
    cout<<"\a\t\t\t**************"<<endl;
    cout<<"\t\t\t| RitikCoder |"<<endl;
...
int SelectNumber1, SelectNumber2, SelectNumber3;
    int main(){
        system("color 02");
            ...
            switch(SDM.studentDataSwitchCaseMenu()){
                case 1:{
                    ReturnValue1= SDM.getStudentDataFormUser();
                    if(ReturnValue1== 1){
